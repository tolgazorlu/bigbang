    ...
    <section className="bg-white">
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 md:h-screen mx-auto lg:py-0">
        ...
        <ul className="steps mb-8">
          <li className="step step-warning">User Information</li>
          <li className={currentStepIndex > 0 ? "step step-warning" : "step"}>
            Validation
          </li>
          <li className={currentStepIndex > 1 ? "step step-warning}" : "step"}>
            Complete
          </li>
        </ul>
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="w-full flex justify-between gap-1">
                {!isFirstStep && (
                  <button
                    onClick={back}
                    className="w-4/12 border text-white bg-blue-700 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                  >
                    Back
                  </button>
                )}

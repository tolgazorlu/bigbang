            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="bg-gray-900 border border-gray-300 text-gray-200 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <p className="text-sm font-light text-gray-400 dark:text-gray-400">
                ...
                <a
                  href="/register"
                  className="font-medium text-gray-300 hover:underline dark:text-primary-500"
                >
                  Register
                </a>
              </p>
